...
public class ShettyHomePageSteps {
	...
	@When("^Click on iFrame courses$")
	public void click_on_iFrame_courses() throws Throwable {
		ShettyHomePageActionsobj.clickIframeCourses();
	}

	@Then("^It should reload iframe coursespage$")
	public void it_should_reload_iframe_coursespage() throws Throwable {
		ShettyHomePageActionsobj.verifyShettyCourses();
	}
